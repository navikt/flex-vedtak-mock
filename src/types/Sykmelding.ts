// Denne er stjålet fra https://github.com/navikt/sykmeldinger/blob/master/client/src/types/sykmelding.ts
...
export class Periode {
    ...
    constructor(periode: any) {
        this.fom = LocalDate.parse(periode.fom)
        this.tom = LocalDate.parse(periode.tom)
