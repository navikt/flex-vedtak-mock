...
function Sykedager({ setForbrukteSykedager, setGjenstaendeSykedager, forbrukteSykedager, gjenstaendeSykedager, setForeløpigBeregnetSluttPåSykepenger, foreløpigBeregnetSluttPåSykepenger, fomTom }: Props) {
    ...
    return (
        <div style={{ border: '1px solid', padding: '1em' }}>
            ...
            <div style={{ paddingTop: '1em' }}>
                <label>Foreløpig beregnet slutt på sykepenger:
